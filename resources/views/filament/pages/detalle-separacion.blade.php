<x-filament::page>
    ...
    <x-filament::card>
        ...
        <div class="grid grid-cols-2 gap-6">
            ...
            <div>
                <div class="mb-2"><strong>Fecha Separación:</strong> {{ $separacion->created_at->format('d/m/Y') }}</div>
                <div class="mb-2"><strong>Monto Separación:</strong> S/ {{ number_format($separacion->monto_separacion ?? 0, 2) }}</div>
     ...
     <!-- Tab Content Sections -->
        ...
        <div class="tab-content active" id="cliente-content">
            ...
            <x-filament::card>
                <x-slot name="heading">
                    Titular: {{ $separacion->proforma->nombres }} {{ $separacion->proforma->ape_paterno }} {{ $separacion->proforma->ape_materno }}
                </x-slot>
                
                <div class="text-sm text-gray-600 mb-4">
                    {{ $separacion->proforma->tipoDocumento->nombre ?? 'DNI' }} {{ $separacion->proforma->numero_documento }} ({{ $separacion->proforma->nacionalidad->nombre ?? 'PERU' }})
                </div>
                ...
                <div class="grid grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <div class="space-y-2 text-sm">
                            ...
                            <div><strong>Fecha Nac.:</strong> {{ $separacion->proforma->fecha_nacimiento ? \Carbon\Carbon::parse($separacion->proforma->fecha_nacimiento)->format('d/m/Y') : '' }}</div>
                    ...
                    <div>
                        ...
                        <div class="space-y-2 text-sm">
                            <div><strong>Estado Civil:</strong> {{ $separacion->proforma->estadoCivil->nombre ?? 'Casado(a)' }}</div>
                            <div><strong>Género:</strong> {{ $separacion->proforma->genero->nombre ?? 'Masculino' }}</div>
                    ...
                    <!-- Información Laboral -->
                    <div>
                        <h4 class="text-blue-600 font-semibold mb-3 border-l-4 border-blue-500 pl-3">Información Laboral</h4>
                        <div class="space-y-2 text-sm">
                            <div><strong>Ocupación:</strong></div>
                            <div><strong>Profesión:</strong> {{ $separacion->proforma->profesion ?? 'Docente' }}</div>
                            <div><strong>Puesto:</strong> {{ $separacion->proforma->puesto ?? 'Cirujano dentista' }}</div>
        ...
        <div class="tab-content" id="inmueble-content">
            ...
            <x-filament::card>
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        <div class="mb-2"><strong>Precio Total:</strong> S/ {{ number_format($departamento->precio, 2) }}</div>
                        <div class="mb-2"><strong>Monto Separación:</strong> S/ {{ number_format($separacion->monto_separacion ?? 0, 2) }}</div>
                        <div class="mb-2"><strong>Saldo Pendiente:</strong> S/ {{ number_format(($departamento->precio - ($separacion->monto_separacion ?? 0)), 2) }}</div>
                    </div>
                </div>
            </x-filament::card>
        </div>
        ...
        <div class="tab-content" id="estado-cuenta-content">
            <x-filament::card>
                ...
                <div class="p-6 text-center text-gray-500">
                    ...
                    <p class="text-sm mt-2">Esta sección mostrará los pagos, saldos pendientes y historial financiero.</p>
                </div>
            </x-filament::card>
        </div>
        ...
        <div class="tab-content" id="devolucion-content">
            <x-filament::card>
                ...
                <div class="p-6 text-center text-gray-500">
                    ...
                    <p class="text-sm mt-2">Esta sección mostrará el historial de devoluciones y procesos de reembolso.</p>
                </div>
            </x-filament::card>
        </div>
        ...
        <div class="tab-content" id="hitos-content">
            <x-filament::card>
                ...
                <div class="p-6 text-center text-gray-500">
                    ...
                    <p class="text-sm mt-2">Esta sección mostrará los hitos y fechas importantes del proceso de venta.</p>
                </div>
            </x-filament::card>
        </div>
        ...
        <div class="tab-content" id="documentos-content">
            <x-filament::card>
                ...
                <div class="p-6 text-center text-gray-500">
                    ...
                    <p class="text-sm mt-2">Esta sección mostrará todos los documentos relacionados con la separación.</p>
                </div>
            </x-filament::card>
        </div>
