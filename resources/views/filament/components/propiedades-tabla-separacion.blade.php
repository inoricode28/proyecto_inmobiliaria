...
function addSelectedProperty() {
    ...
    console.log(`📊 Resumen: ${window.inmueblesSeleccionados.length} inmueble(s) seleccionado(s):`, window.inmueblesSeleccionados);
}
...
function getMultiplePropertiesData() {
    ...
    console.log('📊 Inmuebles procesados:', result.properties.length);
    console.log('📊 IDs de departamentos enviados:', result.properties.map(p => p.departamento_id));
